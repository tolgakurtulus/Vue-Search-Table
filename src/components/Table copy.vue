    ...
    <div class="results" v-if="results">
      <table id="customers">
        ...
        <tr v-for="result in results" :key="result.name">
          ...
          <td> - </td>
          <td> <img class="table-image" v-bind:src="result.images[0].url" alt=""></td>
...
export default {
  ...
  methods: {
    getResult(query){
      axios.get('https://app.ticketmaster.com/discovery/v2/events?apikey=7elxdku9GGG5k8j0Xm8KWdANDgecHMV0&keyword=' + query + '&locale=*').then( response => {
